...
import './components/Navbar.css';  // Stili Navbar
import './components/ParkingForm.css'; // Stili Form
import './components/ParkingList.css'; // Stili Lista Parcheggi
import './components/Footer.css';  // Stili Footer
